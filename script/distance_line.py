...
if content_number_longest_distance_from_point_fc:
    ...
    if point_fc != distance_fc:
        ...
        dq += '"{0}" >= {2} OR "{1}" >= {2}'.format(out_fc_col_oid1_index, out_fc_col_oid2_index, index_threshold - 1)
...
if overwrite is False:
    ...
    if layers_count >= 1:
        ...
        error_message = "when using the option 'overwrite = False', u have to add the distance lines to the content. " \
